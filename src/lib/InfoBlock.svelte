...
<div class="container main mx-auto p-6 bg-white shadow-md rounded ">
  ...
  <div class="main__text-wrapper ">
    <div class="content">
  <h1 class="text-3xl font-bold mb-2 main__title">Кто мы?</h1>
  <hr class="!border-t-8 !border-double pb-4 pt-4 mt-5" />
...
@media screen and (max-width: 860px) {
    ...
    @media (max-width: 768px) {
        .container{
            min-height: 1800px; /* Убедитесь, что на мобильных устройствах высота также автоматическая */
        }
    }
    @media (max-width: 530px) {
        .container{
            min-height: 2000px; /* Убедитесь, что на мобильных устройствах высота также автоматическая */
        }
    }

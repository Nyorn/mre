import { c as create_ssr_component, a as add_attribute, e as escape, d as subscribe, f as each, v as validate_component, j as compute_rest_props, k as spread, l as escape_attribute_value, o as escape_object, p as onDestroy, h as setContext } from "../../chunks/ssr.js";
...
const ImageViewer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${imageUrl ? `<div class="modal svelte-yhxszn"><div class="image-container svelte-yhxszn"><button class="previous svelte-yhxszn" aria-label="Предыдущий слайд" data-svelte-h="svelte-1o79y9v">←</button> <img${add_attribute("src", imageUrl, 0)} alt="Full Size Image" class="image svelte-yhxszn"> <button class="next svelte-yhxszn" aria-label="Следующий слайд" data-svelte-h="svelte-b7f8kf">→</button></div></div>` : `<p data-svelte-h="svelte-1m0pz9w">No image URL provided or modal is hidden.</p>`}`;
});
const css$6 = {
...
const css$3 = {
  code: ".hidden.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{display:none}.flex.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{display:flex}nav.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{background-color:#030005}.contacts.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{display:block}nav.svelte-8gyozz a.svelte-8gyozz.svelte-8gyozz:hover{color:white;transform:scale(1.2)}.logotype.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{margin-top:20px}.hamburger.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{border:white 1px solid}.hamburger.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz:hover{background-color:transparent}ul.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{display:flex;justify-content:flex-end;list-style:none;padding:0;margin:0}ul.svelte-8gyozz li.svelte-8gyozz.svelte-8gyozz{margin-left:10px}nav.svelte-8gyozz a.svelte-8gyozz.svelte-8gyozz{color:white;padding:12px 16px;display:block;text-decoration:none;transition:all 0.3s ease;transform:scale(1.1)}nav.svelte-8gyozz a.svelte-8gyozz.svelte-8gyozz:hover{color:white;transform:scale(1.2)}nav.svelte-8gyozz img.svelte-8gyozz.svelte-8gyozz{margin-bottom:50px;margin-right:-20px;margin-left:-10px}.mre.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{margin-left:-25px}#navbar-language.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{margin-left:auto}#language-dropdown-menu.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{min-width:100%}.mobile-nav-menu.svelte-8gyozz a.svelte-8gyozz.svelte-8gyozz{color:white;padding:12px 16px;display:block;text-decoration:none;transition:all 0.3s ease}.mobile-nav-menu.svelte-8gyozz a.svelte-8gyozz.svelte-8gyozz:hover{text-decoration:underline;background-color:transparent}#navbar-language.svelte-8gyozz>ul.svelte-8gyozz>li.svelte-8gyozz:last-child{margin-right:2rem}nav.svelte-8gyozz .flex.svelte-8gyozz.svelte-8gyozz{display:flex;align-items:center;justify-content:space-between;flex-wrap:nowrap}.mobile-nav-menu.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{flex-direction:column;width:100%;position:absolute;top:20%;left:0;background-color:#030005;z-index:1000;box-shadow:0px 8px 16px 0px rgba(0,0,0,0.2);border-top:1px solid #f3f3f3}:root{--anime-time:8s;--box-size:160px;--clip-distance:0.05;--clip-size:calc(var(--box-size) * (1 + var(--clip-distance) * 2));--path-width:2px;--main-color:#eee}.bb.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{top:0%;bottom:85%;left:0;right:70%;transform:scale(0.9);width:var(--box-size);height:var(--box-size);background:var(--codepen-logo-path) no-repeat 50% / 70% rgba(0, 0, 0, .1);color:var(--main-color);box-shadow:inset 0 0 0 1px rgba(var(--main-color), .5)}.mre.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{white-space:nowrap}.bb.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz::before,.bb.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;z-index:-1;margin:calc(-1 * var(--clip-distance) * 100%);box-shadow:inset 0 0 0 var(--path-width);animation:svelte-8gyozz-clipMe var(--anime-time) linear infinite}.bb.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz::before{animation-delay:calc(var(--anime-time) * -.5)}@keyframes svelte-8gyozz-clipMe{0%,100%{clip:rect(0px, var(--clip-size), var(--path-width), 0px)}25%{clip:rect(0px, var(--path-width), var(--clip-size), 0px)}50%{clip:rect(calc(var(--clip-size) - var(--path-width)), var(--clip-size), var(--clip-size), 0px)}75%{clip:rect(0px, var(--clip-size), var(--clip-size), calc(var(--clip-size) - var(--path-width)))}}nav.svelte-8gyozz button.svelte-8gyozz.svelte-8gyozz{order:2;padding:8px;margin-left:auto}@media(max-width: 1080px){nav.svelte-8gyozz a.svelte-8gyozz.svelte-8gyozz{padding:0px}nav.svelte-8gyozz button.svelte-8gyozz.svelte-8gyozz{order:2;padding:8px;margin-left:auto}.bb.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{transform:scale(0.7);bottom:92%}.logotype.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{margin-left:15px;margin-top:30px}}@media(max-width: 1008px){.bb.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{transform:scale(0.7)}nav.svelte-8gyozz img.svelte-8gyozz.svelte-8gyozz{margin-bottom:50px;margin-right:-20px;margin-left:0px}@media(max-width: 400px){.contacts.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{display:none}}}@media(max-width: 500px){.mobile-nav-menu.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{top:27%}}@media(min-width: 1190px){.navmenu.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{display:flex !important}}@media(max-width: 1190px){.hamburger.svelte-8gyozz.svelte-8gyozz.svelte-8gyozz{display:flex !important}}",
  map: null
};
const Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="bg-white dark:bg-gray-900 w-full top-0 start-0 border-b border-gray-200 dark:border-gray-600 svelte-8gyozz"><div class="mx-auto p-4 py-6 lg:py-8" style="padding-right:10%;padding-left:10%"><div class="flex md:flex-row justify-between items-center svelte-8gyozz"><div class="bb svelte-8gyozz" data-svelte-h="svelte-1jam103"> <div class="logotype mb-0 md:mb-0 flex items-center svelte-8gyozz"><a href="https://sea-estate.com/" class="flex items-center svelte-8gyozz"><img src="data:image/svg+xml;base64," class="h-16 logo svelte-8gyozz" alt="More Real Estate Logo" style="filter: brightness(0) invert(1); "> <div class="flex flex-col items-center ml-2 svelte-8gyozz"><div class="flex items-center svelte-8gyozz"><div class="border-l-2 h-10 border-white mx-2"></div>  <span class="text-3xl font-thin text-white align-middle">SRE</span></div> <span class="mre text-xs uppercase text-white mt-2 svelte-8gyozz">sea real estate</span> </div></a></div></div> <div class="relative items-center md:order-2 space-x-1 md:space-x-8 rtl:space-x-reverse"><button type="button" class="hidden inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white svelte-8gyozz" data-svelte-h="svelte-zj9fb5">English</button>  <div class="${escape("hidden", true) + " absolute z-0 mt-1 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 svelte-8gyozz"}" id="language-dropdown-menu" style="min-width: 100%;"><ul class="py-2 font-medium svelte-8gyozz" role="none" data-svelte-h="svelte-ob7f5o"><li class="svelte-8gyozz"><a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white svelte-8gyozz" role="menuitem"><div class="inline-flex items-center">English</div></a></li> <li class="svelte-8gyozz"><a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white svelte-8gyozz" role="menuitem"><div class="inline-flex items-center">Deutsch</div></a></li> <li class="svelte-8gyozz"><a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white svelte-8gyozz" role="menuitem"><div class="inline-flex items-center">Italiano</div></a></li> <li class="svelte-8gyozz"><a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white svelte-8gyozz" role="menuitem"><div class="inline-flex items-center">中文 (繁體)</div></a></li></ul></div> <button class="hamburger inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 svelte-8gyozz" data-svelte-h="svelte-14d11ly"><span class="sr-only">Open main menu</span> <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h15M1 7h15M1 13h15"></path></svg></button></div> <div class="${escape("hidden", true) + " flex-col xl:hidden mobile-nav-menu svelte-8gyozz"}"${add_attribute("this", navMenu, 0)}><a href="/" class="py-2 px-3 text-gray-900 hover:bg-gray-100 svelte-8gyozz" data-svelte-h="svelte-1uecow0">Главная</a> <a href="/objects" class="py-2 px-3 text-gray-900 hover:bg-gray-100 svelte-8gyozz" data-svelte-h="svelte-1km9hl0">Каталог</a> <a href="#" class="py-2 px-3 text-gray-900 hover:bg-gray-100 svelte-8gyozz" data-svelte-h="svelte-1ky18zk">О нас</a> <a href="#" class="py-2 px-3 text-gray-900 hover:bg-gray-100 svelte-8gyozz" data-svelte-h="svelte-124lhnk">Документы</a> <a href="#" class="py-2 px-3 text-gray-900 hover:bg-gray-100 svelte-8gyozz" data-svelte-h="svelte-5feodu">Контакты</a></div> <div class="navmenu items-center justify-between hidden w-full md:flex md:w-auto md:order-1 svelte-8gyozz" id="navbar-language" data-svelte-h="svelte-q596ob"><ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  svelte-8gyozz"><li class="svelte-8gyozz"><a href="/" class="menu block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 svelte-8gyozz" aria-current="page">Главная</a></li> <li class="svelte-8gyozz"><a href="/objects" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 svelte-8gyozz">Каталог</a></li> <li class="svelte-8gyozz"><a href="/about" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 svelte-8gyozz">О нас</a></li> <li class="svelte-8gyozz"><a href="/404" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 svelte-8gyozz">Документы</a></li> <li class="svelte-8gyozz"><a href="/contacts" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 svelte-8gyozz">Контакты</a></li></ul> <ul class="contacts mr-0 text-xs svelte-8gyozz"><li class="mb-0 svelte-8gyozz"><a href="tel:+359895340006" class="hover:underline svelte-8gyozz">+359 895-340-006</a></li> <li class="mb-0 svelte-8gyozz"><a href="tel:+359877580966" class="hover:underline svelte-8gyozz">+359 877-580-966</a></li> <li class="mb-0 svelte-8gyozz"><a href="tel:+38930535525" class="hover:underline svelte-8gyozz">+38(93)053-55-25</a></li></ul></div></div></div> </nav>`;
});
const css$2 = {
...
const css$1 = {
  code: ".container.svelte-su4aad.svelte-su4aad{display:flex;align-items:center;justify-content:center;min-height:100vh;min-width:100%;background-color:rgb(var(--color-surface-900));background-image:radial-gradient(at 100% 0%, rgba(var(--color-secondary-500) / 0.33) 0px, transparent 50%), radial-gradient(at 2% 1%, rgba(var(--color-error-500) / 0.33) 0px, transparent 50%);overflow-x:hidden}.logotype.svelte-su4aad.svelte-su4aad{position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;transform:scale(0.5)}.logotype.svelte-su4aad img.svelte-su4aad{margin-bottom:50px;margin-right:-20px;margin-left:-10px}.loader.svelte-su4aad.svelte-su4aad{max-width:15rem;width:100%;height:auto;stroke-linecap:round}circle.svelte-su4aad.svelte-su4aad{fill:none;stroke-width:3.5;animation-name:svelte-su4aad-preloader;animation-duration:3s;animation-iteration-count:infinite;animation-timing-function:ease-in-out;transform-origin:170px 170px;will-change:transform}circle.svelte-su4aad.svelte-su4aad:nth-of-type(1){stroke-dasharray:550px;animation-delay:-0.15s}circle.svelte-su4aad.svelte-su4aad:nth-of-type(2){stroke-dasharray:500px;animation-delay:-0.3s}circle.svelte-su4aad.svelte-su4aad:nth-of-type(3){stroke-dasharray:450px;animation-delay:-0.45s}circle.svelte-su4aad.svelte-su4aad:nth-of-type(4){stroke-dasharray:300px;animation-delay:-0.6s}@keyframes svelte-su4aad-preloader{50%{transform:rotate(360deg)}}.loaded.svelte-su4aad.svelte-su4aad{animation:svelte-su4aad-fadeOutPage 2s ease-out forwards}@keyframes svelte-su4aad-fadeOutPage{from{opacity:1;visibility:visible}to{opacity:0;visibility:hidden}}@media(max-width: 440px){.logotype.svelte-su4aad.svelte-su4aad{margin-top:50px}}",
  map: null
};
...
const Preloader = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_loading();
  return `<div class="${["preloader svelte-su4aad", !loading2 ? "loaded" : ""].join(" ").trim()}" data-svelte-h="svelte-5ayylk"><div class="logotype mb-0 md:mb-0 flex items-center justify-center svelte-su4aad"><a href="https://sea-estate.com/" class="flex items-center"><img src="data:image/svg+xml;base64," class="h-16 logo svelte-su4aad" alt="More Real Estate Logo" style="filter: brightness(0) invert(1); "> <div class="flex flex-col items-center ml-2"><div class="flex items-center"><div class="border-l-2 h-10 border-white mx-2"></div>  <span class="text-3xl font-thin text-white align-middle">SRE</span></div> <span class="mre text-xs uppercase text-white mt-2">sea real estate</span> </div></a></div> <div class="container svelte-su4aad"><svg class="loader svelte-su4aad" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 340"><circle cx="170" cy="170" r="160" stroke="#E2007C" class="svelte-su4aad"></circle><circle cx="170" cy="170" r="135" stroke="#404041" class="svelte-su4aad"></circle><circle cx="170" cy="170" r="110" stroke="#E2007C" class="svelte-su4aad"></circle><circle cx="170" cy="170" r="85" stroke="#404041" class="svelte-su4aad"></circle></svg></div> </div>`;
});
const phone = {
  phone: {
    width: 1408,
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$result.head = previous_head;
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-14rvqy_START --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Comfortaa:wght@300..700&display=swap" rel="stylesheet"><script data-svelte-h="svelte-1jxwwyn">(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
      new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
    j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
    'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
  })(window,document,'script','dataLayer','GTM-57S8XWJV');<\/script><script async src="https://www.googletagmanager.com/gtag/js?id=G-2EQQHPBC9X" data-svelte-h="svelte-1yxeyew"><\/script><!-- HEAD_svelte-14rvqy_END -->`, ""}  <noscript data-svelte-h="svelte-kxg2m8"><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-57S8XWJV" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>  ${$loading ? `${validate_component(Preloader, "Preloader").$$render(
      $$result,
      { this: preloader },
      {
        this: ($$value) => {

...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-96iuq1_START -->${$$result.title = `<title>Sea Real Estate: Элитная Недвижимость на Первой Линии Моря в Болгарии</title>`, ""}<meta name="description" content="Sea Real Estate предлагает эксклюзивную недвижимость в туристических зонах Болгарии. Лучшие предложения на первой и второй линии от моря. Узнайте больше!"><script src="https://unpkg.com/three@0.140.2/build/three.min.js" data-svelte-h="svelte-1aqmw51"><\/script><script src="/splide-shader-carousel.min.js" defer data-svelte-h="svelte-147jny7"><\/script><!-- HEAD_svelte-96iuq1_END -->`, ""} <section class="${["splide", !loading ? "loaded" : ""].join(" ").trim()}" aria-label="Splide Shader Carousel Example"><div class="splide__track" data-svelte-h="svelte-xn4djv"><ul class="splide__list"><li class="splide__slide"><img src="https://images.ctfassets.net/31g2btibassa/2C5LnBXILzwiuLyLqXZSOW/f8f3b3f9bc94c38b5d1802074b238032/8.avif" alt="Image 1" class="w-full"></li> <li class="splide__slide"><img src="https://images.ctfassets.net/31g2btibassa/667lBEWzae2sxYHIByfVOX/183209fa433dbf633b527c09118fa59f/9.avif" loading="lazy" alt="Image 2" class="w-full"></li> <li class="splide__slide"><img src="https://images.ctfassets.net/31g2btibassa/5rqygkYnMRWV6SrFF99QV3/52b7097d451ba286d9562728839a4103/11-1-scaled.avif" loading="lazy" alt="Image 3" class="w-full"></li> <li class="splide__slide"><img src="https://images.ctfassets.net/31g2btibassa/2vX2EWllBrw5VA9WeMlQ9q/b3ac2ce275b88f1c46abee6e232227e7/burgas.avif" loading="lazy" alt="Image 4" class="w-full"></li> <li class="splide__slide"><img src="https://images.ctfassets.net/31g2btibassa/5axiBgylT6tNsCoa8Es4Gs/07491832211dd7b7392bc058c3871b78/7.avif" loading="lazy" alt="Image 5" class="w-full"></li></ul></div> <div class="overlay svelte-mwirsd"${add_attribute(
    "style",
